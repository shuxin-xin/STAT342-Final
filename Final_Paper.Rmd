...
=======
  In the Likelihood method, the vaccine efficacy in the combined maximum likelihood estimator is around 95.06\%. The corresponding 95\% confidence interval for the BNT162b2 vaccine efficacy is [0.9155627, 0.9856719]. The likelihood ratio test statistic $W$ is 121.6012. The P-value for the Likelihood Ratio Test statistic using the approximate chi square distribution is $2.822313e\times 10^{-28}$, which is smaller than any common alpha.
>>>>>>> b6978978f42e6409fda91777073c9ff087697dba
