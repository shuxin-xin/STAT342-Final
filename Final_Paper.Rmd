...
Because at $t = 8$, we have $W = 106.5508$, and because the P-value for $P(W > 106.5508) = 1$, which is very small. So, we have enough evidence to reject the null hypothesis and we have $P(\psi > 0.3) = 1$. Therefore, we can conclude that the vaccine efficacy is greater than 30\%.
