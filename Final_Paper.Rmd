...
COVID 19 has afflicted tens of millions of people around the world. In this paper, we want to figure out whether this vaccine past the FDA's requirement that the new vaccine should be at least 30\% efficacy by using three methods: Likelihood, Bayesian, and Bootstrapping. The Likelihood method give us a 95\% Confidence Interval: [0.9155621, 0.9856725] with P-value: $2.822313\times10^{-28}$. The 95\% credible interval for Bayesian prior Beta(0.700102, 1) and Bayesian Prior Beta(1, 1) are [0.9035199, 0.9762552] and [0.9009794, 0.9750466] with P-value: $1.96\times10^{-28}$, $3.73\times10^{-28}$ respectively. And the Bootstrapping method shows that a 95\% Confidence Interval:[0.9097410, 0.9819328] with P-value=0. These results are consistent for us to conclude that the true vaccine efficacy is greater than 30%.
...
Based on the data from table 1 above, we can easily calculated that $\pi_v = \frac{8}{17411}$, $\pi_p = \frac{162}{17511}$, and $\hat{\psi} = \frac{\pi_p - \pi_v}{\pi_p}=0.9503337$.
...
Then, by distributive laws, $P(I)$, the probability of infections, is: $P(I)= \frac{n_1 \pi_v + n_2 \pi_p}{n_1 + n_2}$ (See full process in Appendix 8.1). 
...
Based on the data from table 1, we can easily calculated that $s=x+y=8+162=170$ and $\pi=\frac{\pi_v}{\pi_v+\pi_p}=0.04731632$. Then, $T \sim Binom(s=170, \pi=0.04731632)$ where $\pi_v$ and $\pi_p$ are the probabilities of an infection in the vaccine and placebo groups respectively.
...
Thus, using R, the P-value for the Likelihood Ratio Test statistic using the approximate chi square distribution is $P(W > 121.6012) = P(\psi > 0.3) = 2.822313e\times 10^{-28}$.
...
Maximum Likelihood (ConfI) & 0.9155627 & 0.9856719 & 2.822313×$10^{-28}$  \\ \hline
Bayesian prior Beta(0.700102, 1) (CredI) &  0.9035199 & 0.9762552 & 1.96x$10^{-28}$ \\ \hline
Bayesian Prior Beta(1, 1) (CredI) & 0.9009794 & 0.9750466 & 3.73x$10^{-28}$ \\ \hline
...
\end{table}
  ...
  In the Likelihood method, the vaccine efficacy in the combined maximum likelihood estimator is around 95.06\%. The corresponding 95\% confidence interval for the BNT162b2 vaccine efficacy is [0.9155621, 0.9856725]. The likelihood ratio test statistic $W$ is 121.6012. The P-value for the Likelihood Ratio Test statistic using the approximate chi square distribution is $2.822313 \times 10^{-28}$, which is smaller than any common alpha.
...
# Discussion/Conclusion
  ...
  The 95\% Confidence Intervals for Likelihood and Bootstrap are [0.9155621, 0.9856725] and [0.9097410, 0.9819328] respectively, while the 95\% Credible Intervals for Bayesian prior Beta(0.700102, 1) and Bayesian Prior Beta(1, 1) are [0.9035199, 0.9762552] and [0.9009794, 0.9750466] respectively. The 95\% Bayesian credible interval [0.9035199, 0.9762552] suggests that for $\psi$ represents the vaccine efficacy against COVID 19, the middle 95% of the posterior distribution of vaccine efficacy resulting from the prior $Beta(0.700102, 1)$ is the range 90.3% to 97.6%.
  
  The P-value for Likelihood, Bayesian prior Beta(0.700102, 1), Bayesian Prior Beta(1, 1), and Bootstrap are $2.822313\times10^{-28}$, $1.96\times10^{-28}$, $3.73\times10^{-28}$, and 0 respectively. Because the P-value for Baysian prior Beta(0.700102, 1) is the smallest, this method is most supportive and strongest to reject the null hypothesis that vaccine efficacy is 30%. The probability that the true vaccine efficacy against COVID 19 is greater than 30% is approximately 100%. The evidence suggests that vaccine efficacy is greater than 30%.
  
   (There is a 95% probability that $\psi_0$ in between 90.3% and 97.6%. The 95\% Bayesian credible interval [0.9009794, 0.9750466] suggests that for $\psi$ represents the vaccine efficacy against COVID 19, the middle 95% of the posterior distribution of vaccine efficacy resulting from the prior $Beta(1,1)$ is the range 90.3% to 97.6%. There is a 95% probability that $\psi_0$ in between 90.1% and 97.5%.)
   
  In conclusion, because we calculated all P-value smaller than the significance level 0.05, we have enough evidence to reject the null hypothesis and conclude that the true vaccine efficacy is greater than 30\%. The findings from the three analysis methods (Maximum Likelihood, Bayesian, and non-parametric bootstrapping) are consistent, indicating a high efficacy of the BNT162b2 vaccine.
