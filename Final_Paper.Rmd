...
The median of $\pi$ is `r posterior_median_pi`.
...
The 95\% Bayesian credible interval reported as [0.6015455, 0.6849974], which indicate that there is a 95% probability that the true value of $\psi_0$ falls within the interval [0.6015455, 0.6849974]. We are 95% confident that the true vaccine efficacy against Covid 19 is between approximately  and . It suggests that the true vaccine efficacy is very low and falls within a narrow interval.
