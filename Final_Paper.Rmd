...
$h(\pi_0|t) = Beta(0.700102+8, 162-8+1) = Beta(8.700102, 163)$
...
$h(\pi_0|t) = Beta(1+8, 162-8+1) = Beta(9, 163)$
...
$$P(\psi_0 \leq 0.3|t) = P(\frac{1-2\pi}{1-\pi} \leq 0.3|t) = P(\pi \geq 0.4117647)$$
...
The posterior probability $P(\psi_0 > 0.3|t)=1.96 \times 10^{-28}$, which is very small, so $P(\psi_0 > 0.3|t)$ is approximately 1, which means that the probability that the true vaccine efficacy against Covid 19 is greater than 30% is about 100%. The evidence suggests that vaccine efficacy is greater than 30%.
