...
&= 2[8 \cdot (ln(1 - 0.9506173) - ln(2 - 0.9506173)) + (8 - 170) * ln(2 - 0.9506173) \\
...
Because at $t = 8$, we have $W = 106.5508$, and because the P-value for $P(W < 121.6012) = 2.822313e\times 10^{-28}$, which is very small. So, we have enough evidence to reject the null hypothesis and we have $P(\psi > 0.3) = 1$. Therefore, we can conclude that the vaccine efficacy is greater than 30\%.
